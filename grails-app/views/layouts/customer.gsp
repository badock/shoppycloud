  ...
  <body>
        ...
        <div class="container-fluid">
          ...
          <div class="nav-collapse">
            <ul class="nav">
              ...
              <li class="active"><g:link controller="customerManagement" action="index">My Account</g:link></li>
              </sec:ifAllGranted>
            </ul>
	...
	<div class="subnav subnav-fixed">
    	<ul class="nav nav-pills">
    		<li>
				<g:link class="list" controller="customerManagement" action="listInformations">
					My informations
				</g:link>
			</li>
			<li>
				<g:link class="list" controller="customerManagement" action="listOrders">
					My orders
				</g:link>
			</li>
    	</ul>
